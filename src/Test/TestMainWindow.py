    ...
    def start_detection(self):
        ...
        def show_fatigue_info(fatigue_detector):
            ...
            self.windows.label_2.setText(f"当前疲劳指标为:{current_fatigue_indicator}\n"
                                         ...
                                         f"总检测时长:{fatigue_detector.total_time}")
        ...
        prompt_interval_minute = 1    # CONFIG["prompt_interval_minute"]
        minimum_prompt_level = 0    # CONFIG["minimum_prompt_level"]
        ...
        while self.camera.isOpened():
            ...
            self.windows.pushButton.setText(f"{current_minute}分")
